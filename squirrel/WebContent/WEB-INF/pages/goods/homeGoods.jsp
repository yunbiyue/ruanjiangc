    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            <a href="<%=basePath%>goods/homeGoods" class="logo">
                <em class="em1">南方姑娘</em>
                <em class="em2">二手书平台</em>
                <em class="em3"></em>
            </a>
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到南方姑娘的二手书平台。书是知识的载体。纸</p>
                                <p class="text3">张虽会泛黄，但知识不会消失。多读一本书，多交了个</p>
                                <p class="text4">个益友。为此我们打造了一个全新的二手书平台——<span>南方姑娘的二手书平台</p>
                                <p class="text5">这里有更多的闲置分享，更优秀的服务质量，你想要的，都在这里。</p>
                                <p class="text6">加入南方姑娘的二手书平台，让你感受不一样的精彩。</p>
                            </ul>
                          <!--   <div class="logoimg">
